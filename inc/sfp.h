...
class SFP_prefetcher : public Prefetcher {
    public:
        ...
        void fetchPredictedFootprint(SHT_entry &entry, uint64_t addr, vector<uint64_t> &pref_addr);
        ...
        void fetchDefaultPrediction(uint64_t addr, vector<uint64_t> &pref_addr);
